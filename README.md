# Portafolio Profesional — Carlos Ariel Cuadras
...
Bienvenido a mi portafolio web personal. Este proyecto es una demostración interactiva de mis habilidades como **Ingeniero en Sistemas** y **Full Stack Developer**.

El sitio combina diseño moderno, animaciones fluidas y elementos 3D interactivos para crear una experiencia de usuario única, sirviendo como escaparate para mis proyectos de IoT, desarrollo web y software de escritorio.
...
```text
├── public/          # Assets estáticos (Modelos 3D .glb, imágenes, favicon)
├── src/
│   ├── components/  # Componentes modulares (Navbar, Lanyard 3D, Cards)
│   ├── assets/      # Imágenes importadas dentro de componentes
│   ├── App.jsx      # Componente principal y lógica de rutas/scroll
│   ├── data.js      # Datos dinámicos (Lista de proyectos, herramientas)
